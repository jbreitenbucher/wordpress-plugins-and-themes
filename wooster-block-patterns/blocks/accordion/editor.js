( function( wp ) {
  ...
  wp.blocks.registerBlockType( 'wbp/accordion', {
    edit: function( props ) {
      const { clientId } = props;
      const blockProps = useBlockProps( { className: 'wbp-accordion' } );
    ...
    save: function() {
      const blockProps = wp.blockEditor.useBlockProps.save( { className: 'wbp-accordion' } );
