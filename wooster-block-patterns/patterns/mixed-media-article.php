...
<div class="wp-block-group wbp-container">
	...
	<figure class="wp-block-gallery has-nested-images columns-3 is-cropped">
		...
		<figure class="wp-block-image size-large">
			<img src="<?php echo esc_url( WBP_ASSETS_URL . "images/image-6.jpg" ); ?>" alt="Black-bellied Whistling-Ducks" />
		...
		<!-- wp:image {"sizeSlug":"large","linkDestination":"none"} -->
		<figure class="wp-block-image size-large">
			<img src="<?php echo esc_url( WBP_ASSETS_URL . "images/image-2.jpg" ); ?>" alt="Fungus on a rotting log" />
			<figcaption>Photo: Jon Breitenbucher</figcaption>
		</figure>
		<!-- /wp:image -->
		...
		<!-- wp:image {"sizeSlug":"large","linkDestination":"none"} -->
		<figure class="wp-block-image size-large">
			<img src="<?php echo esc_url( WBP_ASSETS_URL . "images/image-4.jpg" ); ?>" alt="Monarch Butterfly on Blazing Star" />
			<figcaption>Photo: Jon Breitenbucher</figcaption>
		</figure>
		<!-- /wp:image -->
	</figure>
	...
	<figure class="wp-block-image alignleft size-medium is-resized">
		<img src="<?php echo esc_url( WBP_ASSETS_URL . "images/image-1.jpg" ); ?>" alt="Yellow flower" width="320" />
	...
	<figure class="wp-block-image alignright size-medium is-resized">
		<img src="<?php echo esc_url( WBP_ASSETS_URL . "images/image-5.jpg" ); ?>" alt="Wild Teasle" width="300" />
		<figcaption>Jon Breitenbucher</figcaption>
	</figure>
	<!-- /wp:image -->
