...
add_action('genesis_before','gsl_areas_of_expertise_loop_setup');
function gsl_areas_of_expertise_loop_setup() {

    if ( ! genesis_html5() ) {
        // Customize Before Loop
            remove_action('genesis_before_loop','genesis_do_before_loop' );
            add_action('genesis_before_loop','gsl_areas_of_expertise_before_loop');
        ...
        // Customize Post Content
            ...
            add_action('genesis_post_content','gsl_areas_of_expertise_post_content');
        ...
        // Customize Post Content
            ...
            add_action( 'genesis_entry_content', 'gsl_areas_of_expertise_post_content' );
...
function gsl_areas_of_expertise_before_loop() {
...
function gsl_areas_of_expertise_post_content () {
    $taxonomy     = 'expertise';
    $orderby      = 'name';
