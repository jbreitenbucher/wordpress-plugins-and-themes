(function (wp) {
  ...
  wp.blocks.registerBlockType('ibp/accordion-item', {
    attributes: {
      title: { type: 'string', source: 'text', selector: 'button.ibp-accordion__button .ibp-accordion__label' },
    ...
    edit: function (props) {
      ...
      const controlId = 'ibp-acc-control-' + uid;
      const panelId   = 'ibp-acc-panel-' + uid;
      ...
      const blockProps = useBlockProps({
        className: 'ibp-accordion__item' + (attributes.open ? ' is-open' : '')
      });
      ...
      const header = el(
        'h3',
        { className: 'ibp-accordion__heading' },
        el(
          'button',
          {
            type: 'button',
            className: 'ibp-accordion__button',
          ...
          el('span', { className: 'ibp-accordion__icon', 'aria-hidden': 'true' }),
          el(RichText, {
            tagName: 'span',
            className: 'ibp-accordion__label',
      ...
      const panel = el(
        ...
        {
          id: panelId,
          className: 'ibp-accordion__panel',
          role: 'region',
    ...
    save: function (props) {
      ...
      return el(
        ...
        el(
          'div',
          { id: panelId, className: 'ibp-accordion__panel', role: 'region', 'aria-labelledby': controlId },
