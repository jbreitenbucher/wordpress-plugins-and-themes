...
(function(){
	...
	function enhance(root){
		...
		const buttons = root.querySelectorAll('.wbp-accordion__button');
		buttons.forEach(btn => {
			btn.addEventListener('click', () => {
				...
				const item = btn.closest('.wbp-accordion__item');
	...
	ready(function(){
		document.querySelectorAll('.wbp-accordion').forEach(enhance);
	});
})();
